import { AbstractProvider, BlockTag, TransactionReceipt, TransactionRequest, Provider, Networkish, Signer, FetchRequest } from 'ethers';
export declare const DEFAULT_FLASHBOTS_RELAY = "https://relay.flashbots.net";
export declare const BASE_FEE_MAX_CHANGE_DENOMINATOR = 8n;
export declare const BLOCK_API = "https://blocks.flashbots.net/v1/blocks";
...
export declare class FlashbotsBundleProvider extends AbstractProvider {
    #private;
     ...
     * ```
     */
    static create(genericProvider: Provider, authSigner: Signer, url?: string | FetchRequest, network?: Networkish): Promise<FlashbotsBundleProvider>;
    /**
