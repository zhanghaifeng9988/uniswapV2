...
const CHAIN_ID = 1;
const provider = new ethers_1.JsonRpcProvider(process.env.ETHEREUM_RPC_URL || 'http://127.0.0.1:8545', {
    chainId: CHAIN_ID,
    ensAddress: '',
    name: 'mainnet'
});
...
function printGasPricing(gasPricing) {
    ...
    console.log(`[searcher] Gas Fees: ${(0, ethers_1.formatUnits)(gasPricing.gasFeesPaidBySearcher)} ETH`);
    console.log(`[searcher] Effective Gas Price: ${(0, ethers_1.formatUnits)(gasPricing.effectiveGasPriceToSearcher, 'gwei')} gwei`);
    console.log(`[miner] Priority Fees: ${(0, ethers_1.formatUnits)(gasPricing.priorityFeesReceivedByMiner)} ETH`);
    console.log(`[miner] Effective Priority Fee Per Gas: ${(0, ethers_1.formatUnits)(gasPricing.effectivePriorityFeeToMiner, 'gwei')} gwei`);
}
async function main() {
