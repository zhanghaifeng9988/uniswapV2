...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    // 添加getReserves函数的实现，用于测试中的调用
    function getReserves(address _factory, address tokenA, address tokenB) external view returns (uint reserveA, uint reserveB) {
